...
namespace DropZoneApp
{
    public sealed class SettingsForm : Form
    {
        ...
        public SettingsForm(AppConfig config, Action? applyNow = null)
        {
            ...
            // --- Drop‑Zone ---
            var grpDZ = new GroupBox { Text = "Drop‑Zone", Left = 12, Top = 206, Width = 350, Height = 170 };
            ...
            // --- Dock ---
            var grpDock = new GroupBox { Text = "Dock (halbtransparent)", Left = 380, Top = 206, Width = 350, Height = 220 };
            ...
            var btnLog = new Button { Text = "Log anzeigen …", Left = 12, Top = 616, Width = 120 };
            btnLog.Click += (_, __) => LogForm.ShowSingleton(this);

            var btnClose = new Button { Text = "Schließen", Left = 634, Top = 616, Width = 96, DialogResult = DialogResult.OK };
            ...
            _txtTarget.TextChanged += (_, __) => {
                if (!string.IsNullOrWhiteSpace(_txtTarget.Text)) {
                    Directory.CreateDirectory(_txtTarget.Text);
                    _config.TargetFolder = _txtTarget.Text;
